...
class APIManager {
    ...
    func getSeoulData() {
        ...
        let url = "http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?ServiceKey=\(APIKeyManager().apiKey)&areaCode=36&numOfRows=450&contentTypeId=12&&cat1=A02&cat2=A0201&MobileOS=ETC&MobileApp=AppTest&_type=json"
