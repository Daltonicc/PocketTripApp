...
class APIManager {
    ...
    func getSpotDetailData(contentId: Int, result:@escaping (JSON) -> ()) {
        ...
        let url = "http://api.visitkorea.or.kr/openapi/service/rest/KorService/detailCommon?ServiceKey=\(APIKeyManager().apiKey)&overviewYN=Y&firstImageYN=Y&contentTypeId=12&contentId=\(contentId)&MobileOS=ETC&MobileApp=AppTest&_type=json"
    ...
    func getSeoulData() {
        ...
        let url = "http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?ServiceKey=\(APIKeyManager().apiKey)&areaCode=31&numOfRows=450&contentTypeId=12&&cat1=A02&cat2=A0201&MobileOS=ETC&MobileApp=AppTest&_type=json"
